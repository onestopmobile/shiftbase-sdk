 ...
 */
final class ShiftbaseJsonEndpointRequest extends Request implements HasBody
{
    use HasJsonBody;
     ...
     * @param  ShiftbasePayload  $endpointPayload
     */
    public function __construct(
        ...
        array $query = [],
        private readonly array $endpointPayload = [],
    ) {
        $this->method = $method;
    ...
    /**
     * @return ShiftbasePayload
     */
    protected function defaultBody(): array
    {
        return $this->endpointPayload;
    }
